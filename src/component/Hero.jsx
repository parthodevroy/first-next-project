...
const Hero = () => {
  return (
    <section className="bg-gradient-to-r from-amber-300 to-yellow-100 rounded-lg p-8 mb-8">
      <div className="max-w-3xl">
        ...
        <div className="flex gap-3">
          <p href="/products" className="px-5 py-3 bg-blue-600 text-white rounded-md">Browse Products</p>
